...
from deeplab_lfov import DeepLabLFOVModel, seismic_ImageReader
...
SAVE_DIR = 'E:/huhuang/deep_lab/F3_0915_1largefov/images/'#保存的文件夹
SNAPSHOT_DIR = 'E:/huhuang/deep_lab/F3_0915_1largefov/checkpoints/deeplab_lfov_1k/'
...
elapsed = (time.time() - start_time_sum) / 3600
print('run time = {:.3e} h'.format(elapsed))